...
import { infoFormTheme } from '../../components/formView';
import { BrowseList } from './browseList';
import { TypeChoiceList } from './typeChoiceList';
import {
...
export class UserMenuPopup extends ComposedPopup {
    ...
    private readonly browseList = new BrowseList();
    private readonly typeChoiceList = new TypeChoiceList();
    ...
    private renderBrowseBuffer(theme: Theme): FrameBuffer {
        return this.browseList.render(theme, this.viewMode, this.filteredItems,
            this.cursor, this.scroll, {
                padH: this.padH, padV: this.padV,
                width: this.dialogWidth, visibleHeight: this.visibleHeight,
            });
    }
    ...
    private renderTypeChoiceBuffer(theme: Theme): FrameBuffer {
        return this.typeChoiceList.render(theme, this.typeChoiceCursor, this.padH, this.padV);
    }
