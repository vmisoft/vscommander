...
Welcome to VSCommander -- a dual-panel file manager for
Visual Studio Code, inspired by Far Manager.

Press `Ctrl+O` to toggle the file panel on and off.
Your shell session stays intact underneath.
