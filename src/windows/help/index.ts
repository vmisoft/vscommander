...
import { helpFormTheme } from '../../components/formView';
import { FrameBuffer } from '../../frameBuffer';
import { CheckboxControl } from '../../components/checkboxControl';
import { HelpLine, HelpTopic, loadHelpTopics, loadHelpFile, parseHelpFile } from '../../helpParser';
import { HelpContentsArea } from './helpContentsArea';
import { HelpViewerArea, HelpLink } from './helpViewerArea';
import {
...
export class HelpPopup extends ComposedPopup {
    ...
    private docsDir = '';
    private linkPositions: HelpLink[] = [];
    ...
    private readonly contentsArea = new HelpContentsArea(() => ({
        topics: this.topics,
        cursor: this.cursor,
        contentsScroll: this.contentsScroll,
        viewportHeight: this.viewportHeight,
        checkbox: this.interceptF1Cb,
    }));
    private readonly viewerArea = new HelpViewerArea(() => ({
        lines: this.lines,
    ...
    private buildContentsView(): void {
        ...
        view.addComponent(this.contentsArea);
    ...
    private buildViewerView(): void {
        ...
        view.addComponent(this.viewerArea);
