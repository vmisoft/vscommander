...
const MOCK_ENTRIES: DirEntry[] = [
    { name: '..', isDir: true, size: 0, mtime: new Date(0) },
    { name: '.git', isDir: true, size: 0, mtime: new Date('2025-01-10') },
    { name: '.github', isDir: true, size: 0, mtime: new Date('2025-01-09') },
    { name: 'build', isDir: true, size: 0, mtime: new Date('2025-01-12') },
    { name: 'dist', isDir: true, size: 0, mtime: new Date('2025-01-14') },
    { name: 'docs', isDir: true, size: 0, mtime: new Date('2025-01-08') },
    { name: 'node_modules', isDir: true, size: 0, mtime: new Date('2025-01-02') },
    { name: 'src', isDir: true, size: 0, mtime: new Date('2025-01-15') },
    { name: 'tests', isDir: true, size: 0, mtime: new Date('2025-01-11') },
    { name: '.eslintrc.json', isDir: false, size: 128, mtime: new Date('2025-01-04') },
    { name: '.gitignore', isDir: false, size: 234, mtime: new Date('2025-01-05') },
    { name: 'CHANGELOG.md', isDir: false, size: 5678, mtime: new Date('2025-01-13') },
    { name: 'LICENSE', isDir: false, size: 1089, mtime: new Date('2025-01-01') },
    { name: 'Makefile', isDir: false, size: 456, mtime: new Date('2025-01-06') },
    { name: 'README.md', isDir: false, size: 2345, mtime: new Date('2025-01-13') },
    { name: 'index.ts', isDir: false, size: 1234, mtime: new Date('2025-01-15') },
    { name: 'package-lock.json', isDir: false, size: 98765, mtime: new Date('2025-01-14') },
    { name: 'package.json', isDir: false, size: 567, mtime: new Date('2025-01-14') },
    { name: 'tsconfig.json', isDir: false, size: 456, mtime: new Date('2025-01-11') },
    { name: 'webpack.config.js', isDir: false, size: 789, mtime: new Date('2025-01-09') },
];
